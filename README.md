...
- Use `--enhanced-obs-features` to append compact engineered strategy features (build deficits/readiness, production opportunity, discard pressure, VP pressure, short-horizon public resource-flow memory, robber-target quality proxies, expansion/achievement race pressure, and trade-credibility signals) to the RL input.
